...
%         line([time_detect time_detect],[min(min(acc1_on_v1_past_norm_d),min(acc2_on_v2_past_norm_d))-1 max(max(acc1_on_v1_past_norm_d),max(acc2_on_v2_past_norm_d))+1],'color','k');
%         plot(time_detect,max(max(acc1_on_v1_past_norm_d),max(acc2_on_v2_past_norm_d))+1,'b+');
%         line([time_strategy time_strategy],[min(min(acc1_on_v1_past_norm_d),min(acc2_on_v2_past_norm_d))-1 max(max(acc1_on_v1_past_norm_d),max(acc2_on_v2_past_norm_d))+1],'color','k');
%         plot(time_strategy,max(max(acc1_on_v1_past_norm_d),max(acc2_on_v2_past_norm_d))+1,'rh');
